        ...
        <div id='projects'>
            ...
            <div className="grid lg:grid-cols-3 container rounded-lg mx-auto mb-16">
                <label className="hover:cursor-pointer bg-secondary ease-in-out transition duration-200 h-56 relative" htmlFor="wip-modal">
                    ...
                    <div className="text-center relative p-8">
                        <p className="text-important text-3xl font-bold mb-4" style={{textShadow:'0px 0px 20px #000000'}}>Machine Learning Stock Predictor</p>
            ...
            <div className="modal">
                <div className="modal-box bg-secondary">
                    ...
                    <a href="https://umd-loop.vercel.app/" className="text-important hover:underline">UMD Loop Website</a>
                    <div className="modal-action">
            ...
            <div className="modal">
                <div className="modal-box bg-secondary">
                    ...
                    <a href="https://lecture-gpt.vercel.app/" className="text-important hover:underline">LectureGPT Website</a>
                    <div className="modal-action">
            ...
            <div className="modal">
                <div className="modal-box bg-secondary">
                    ...
                    <a href="https://apps.apple.com/us/app/bay-ridge-trails/id1551006001" className="text-important hover:underline">Trails App</a>
                    <div className="modal-action">
            ...
            <div className="modal">
                <div className="modal-box bg-secondary">
                    ...
                    <a href="https://github.com/RodzAmor/Cannon-Ball-Projectile-Simulator" className="text-important hover:underline">Github Link</a>
                    <div className="modal-action">
            ...
            <div className="modal">
                <div className="modal-box bg-secondary">
                    ...
                    <a href="https://www.doghousefit.com/" className="text-important hover:underline">Fitness Website</a>
                    <div className="modal-action">
