    ...
    return (
        <>
            ...
            <div className='block text-center mb-8'>
                <a href="https://colab.research.google.com/drive/12iWQhXGDHkB9ixfJSYhPvgTSxszcdd9K?usp=sharing" className="text-important text-2xl hover:underline" target="_blank">Google Colab</a>
            </div>
